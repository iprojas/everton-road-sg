...
const cameraPositions = {
  ...
  second: [
    20.158933526860993, 5.903435092595209, 9.050581293867282,
    8.183015351089564, 5.642161597038238, -1.4792102528298048,
  ],
  third: [
  ...
  fourth: [
    -27.633544592239733, 5.550605045436712, 10.3419344591902385,
    -0.633544489691525, 5.550604942888504, -1.4444829746514958,
  ],
};
  ...
  return (
    <>
      ...
      <group ref={mainGroup}>
        ...
        {/* ENVIRONMENT */}
        <Environment preset="park" background blur={blur}></Environment>
